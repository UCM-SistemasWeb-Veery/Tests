...
[repositorio](https://github.com/UCM-SistemasWeb-Veery/Tests/img/Repositorio.png)  
...
[cambiar branch](https://github.com/UCM-SistemasWeb-Veery/Tests/img/)
2. Nos interesa hacer un **pull request**, asique al lío. Pulsamos el botón "Pull request"  
[pull request](https://github.com/UCM-SistemasWeb-Veery/Tests/img/crear_pull_request.png)  
y rellenamos los campos...
[editar pull](https://github.com/UCM-SistemasWeb-Veery/Tests/img/editar_request.png)
[editar pull](https://github.com/UCM-SistemasWeb-Veery/Tests/img/editar_request_2.png)
...
[merge pull request](https://github.com/UCM-SistemasWeb-Veery/Tests/img/merge_request)  
5. Y ya está, ya podemos borrar el branch, que no sirve para nada
[borrar branch viejo](https://github.com/UCM-SistemasWeb-Veery/Tests/img/merge_terminado.png)  
